...
if errorlevel 1 (
    ...
    mkdir dataset 2>nul
    mkdir dataset\Aleksander 2>nul
...
echo    python main.py
echo    -> Нажмите Захватить фото Aleksanderа
echo    -> Нажмите Захватить фото Egorа
echo.
...
echo    dataset\Aleksander\     - фото Aleksanderа
echo    dataset\Egor\          - фото Egorа
echo    dataset\Unknown\   - фото других людей
